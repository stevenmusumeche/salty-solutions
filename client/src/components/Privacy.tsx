      ...
      <div className="container mx-auto my-4">
        <div className="forecast-wrapper">
          <div>
            ...
            <p className="mb-4">
              Steven Musumeche built the Salty Solutions app as a Free app. This
              SERVICE is provided by Steven Musumeche at no cost and is intended
              for use as is.
            </p>
            <p className="mb-4">
            ...
            <p className="mb-4">
              ...
              our Terms and Conditions, which is accessible at Salty Solutions
            ...
            <h2 className="text-2xl mb-4">Service Providers</h2>
            <p className="mb-4">
            ...
            <h2 className="text-2xl mb-4">Links to Other Sites</h2>
            <p className="mb-4">
            ...
            <p className="mb-4">This policy is effective as of 2020-07-12</p>
            <h2 className="text-2xl mb-4">Contact Us</h2>
            <p className="mb-4">
              If you have any questions or suggestions about my Privacy Policy,
              do not hesitate to contact me at steven@musumeche.com.
            </p>
          </div>
        </div>
      </div>
