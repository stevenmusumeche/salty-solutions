...
export const noaaStations: NoaaStationEntity[] = [
  ...
  {
    id: "KBQX",
    name: "Brazos 538 (Transco)",
    coords: { lat: 28.314, lon: -95.62 },
    availableParams: [NoaaProduct.Wind, NoaaProduct.AirTemperature],
    type: NoaaStationType.Buoy,
  },
  {
  ...
  },
  {
    id: "8775241",
    name: "Aransas Pass",
    coords: { lat: 27.83666, lon: -97.0383 },
    availableParams: [
      NoaaProduct.TidePrediction,
      NoaaProduct.WaterLevel,
      NoaaProduct.Wind,
  ...
  },
  {
    ...
    coords: { lat: 27.633333, lon: -97.236667 },
    availableParams: [
      NoaaProduct.TidePrediction,
      NoaaProduct.WaterLevel,
      NoaaProduct.WaterTemperature,
  ...
  },
  {
    id: "8774770",
    name: "Rockport",
    coords: { lat: 28.021667, lon: -97.046667 },
    availableParams: [
      NoaaProduct.TidePrediction,
      NoaaProduct.WaterLevel,
      NoaaProduct.WaterTemperature,
  ...
  },
  {
    ...
    coords: { lat: 27.90833, lon: -97.135 },
    availableParams: [NoaaProduct.TidePrediction],
    type: NoaaStationType.Station,
  },
  {
    ...
    coords: { lat: 27.58, lon: -97.216667 },
    availableParams: [
      NoaaProduct.TidePrediction,
      NoaaProduct.WaterLevel,
      NoaaProduct.AirTemperature,
  ...
  },
  {
    ...
    coords: { lat: 27.485, lon: -97.318333 },
    availableParams: [
      NoaaProduct.WaterLevel,
      NoaaProduct.WaterTemperature,
      NoaaProduct.Wind,
